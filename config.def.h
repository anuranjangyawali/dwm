...
static const char *fonts[]          = { "JetBrains Mono:size=13", "fontawesome:pixelsize=10:antialias=true:autohint=true", "JetBrainsMono Nerd Font:pixelsize=18:antialias=true:autohint=true" };
